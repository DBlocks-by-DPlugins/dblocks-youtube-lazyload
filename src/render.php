    ...
    $svgIcons = [
        ...
        '<svg width="25" height="24" viewBox="0 0 25 24" fill="none">
            ...
            <path 
                ...
                d="M10.2941 15.5294V8.47058L16.647 12L10.2941 15.5294Z" 
            />
        </svg>',
        ...
        '<svg width="25" height="24" viewBox="0 0 25 24" fill="none">
            <circle 
                fill="' . $play_background . '"                 
                cx="12.353" cy="12" r="11.2941" />
            <path 
                fill="' . $play_icon_color . '" 
                d="M9.88232 15.5294V8.47058L16.2353 12L9.88232 15.5294Z" "/>
        </svg>',

        '<svg width="25" height="24" viewBox="0 0 25 24" fill="none">
            <rect 
                fill="' . $play_background . '"                 
                x="0.176392" width="24" height="24" />
            <path 
                fill="' . $play_icon_color . '" 
                d="M6.5293 19.0588V4.94116L19.2352 12L6.5293 19.0588Z"  
                />
        </svg>',
        ...
        '<svg width="25" height="24" viewBox="0 0 25 24" fill="none">
            <rect 
                fill="' . $play_background . '"  
                x="0.470581" width="24" height="24" rx="2.82353" />
            <path 
                fill="' . $play_icon_color . '"
                d="M6.82349 18.3096V5.69037C6.82349 4.88109 7.69454 4.37098 8.40034 4.76692L19.6479 11.0765C20.369 11.481 20.369 12.5189 19.6479 12.9234L8.40034 19.2331C7.69454 19.629 6.82349 19.1189 6.82349 18.3096Z" />
        </svg>',

        '<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
                fill="' . $play_background . '"
                d="M0.705933 24V0L22.7059 12L0.705933 24Z" />
        </svg>',

        '<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
                fill="' . $play_background . '"
                d="M1.76471 21.6157V2.3843C1.76471 1.31128 2.91446 0.630508 3.8553 1.14645L21.3898 10.7621C22.3671 11.2981 22.3671 12.7019 21.3898 13.2379L3.8553 22.8535C2.91446 23.3695 1.76471 22.6887 1.76471 21.6157Z" />
        </svg>',
    ];
